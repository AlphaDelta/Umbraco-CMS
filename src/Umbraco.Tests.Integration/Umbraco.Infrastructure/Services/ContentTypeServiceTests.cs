...
namespace Umbraco.Cms.Tests.Integration.Umbraco.Infrastructure.Services
{
    ...
    public class ContentTypeServiceTests : UmbracoIntegrationTest
    {
        ...
        public void CanSaveAndGetIsElement()
        {
            ...
            contentType.PropertyGroups.Add(new PropertyGroup(contentCollection) { Name = "Content", Alias = "content", SortOrder = 1 });
        ...
        private ContentType CreateComponent()
        {
            ...
            component.PropertyGroups.Add(new PropertyGroup(contentCollection) { Name = "Component", Alias = "component", SortOrder = 1 });
