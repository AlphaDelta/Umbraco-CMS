...
namespace Umbraco.Cms.Tests.Integration.Umbraco.Infrastructure.Services
{
    ...
    public class ContentTypeServiceVariantsTests : UmbracoIntegrationTest
    {
        ...
        public void Change_Variations_ComposedContentType_1()
        {
            ...
            composing.PropertyGroups.Add(new PropertyGroup(properties1) { Name = "Content", Alias = "content" });
            ...
            composed.PropertyGroups.Add(new PropertyGroup(properties2) { Name = "Content", Alias = "content" });
        ...
        public void Change_Variations_ComposedContentType_2()
        {
            ...
            composed1.PropertyGroups.Add(new PropertyGroup(properties2) { Name = "Content", Alias = "content" });
            ...
            composed2.PropertyGroups.Add(new PropertyGroup(properties3) { Name = "Content", Alias = "content" });
