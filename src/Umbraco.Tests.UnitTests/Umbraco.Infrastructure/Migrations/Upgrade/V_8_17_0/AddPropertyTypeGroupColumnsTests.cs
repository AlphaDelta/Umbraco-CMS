...
namespace Umbraco.Cms.Tests.UnitTests.Umbraco.Infrastructure.Migrations.Upgrade.V_8_17_0
{
    ...
    public class AddPropertyTypeGroupColumnsTests
    {
        ...
        private readonly ILogger<AddPropertyTypeGroupColumns> _migrationLogger = Mock.Of<ILogger<AddPropertyTypeGroupColumns>>();
        ...
        public void CreateColumn()
        {
            ...
            var migration = new AddPropertyTypeGroupColumns(context, _migrationLogger, _shortStringHelper);
